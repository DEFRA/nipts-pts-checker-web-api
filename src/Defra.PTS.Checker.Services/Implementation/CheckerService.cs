...
using Defra.PTS.Checker.Repositories.Enums;
...
namespace Defra.PTS.Checker.Services.Implementation
{
    public class CheckerService : ICheckerService
    {
        ...
        public CheckerService(ILogger<CheckerService> log, IPetRepository petRepository, IApplicationRepository applicationRepository, ITravelDocumentRepository travelDocumentRepository)
        {
            _log = log;
